...
import Architect.ArchitectRegistrationActivity;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loginButton = (Button) findViewById(R.id.main_log_in_btn);
...
sellerBegin.setOnClickListener(new View.OnClickListener() {
    ...
    public void onClick(View view) {
        Intent intent = new Intent(MainActivity.this, ArchitectRegistrationActivity.class);
        ...
        RootRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.child("Users").child(phone).exists()) {
                    Users usersData = (Users) snapshot.child("Users").child(phone).getValue(Users.class);
