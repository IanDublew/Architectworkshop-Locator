...
public class AdminAddNewProduct extends AppCompatActivity {
    ...
    private String  Description, Price, Pname,Seller,Location,saveCurrentDate, saveCurrentTime;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button addNewProductButton = (Button) findViewById(R.id.add_new_product);
        InputProductImage =(ImageView) findViewById(R.id.select_product_image);
        InputProductName = (EditText) findViewById(R.id.product_name);
        InputProductPrice = (EditText) findViewById(R.id.product_price);
        InputProductDescription = (EditText) findViewById(R.id.product_description);
        InputSeller = (EditText) findViewById(R.id.product_seller);
        InputLocation =(EditText) findViewById(R.id.admin_architect_location_link);
                ...
                Task<Uri>urlTask = uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                    ...
                    public void onComplete(@NonNull Task<Uri> task) {
                        if(task.isSuccessful())
                        {
                            ...
                            Toast.makeText(AdminAddNewProduct.this, "Product Image Url Is Received Successfully", Toast.LENGTH_SHORT).show();
    ...
    private void saveProductInfoToDatabase() {
        ...
        productMap.put("category",AdminCategoryName);
